function projected_gamma=projection_cone_realign(gamma,r,recovStruct,varargin )
...
xxdx_ychannel=gamma(12*N+1:13*N,:);
xxdy_ychannel=gamma(13*N+1:14*N,:);
yydx_ychannel=gamma(14*N+1:15*N,:);
yydy_ychannel=gamma(15*N+1:16*N,:);
zzdx_ychannel=gamma(16*N+1:17*N,:);
zzdy_ychannel=gamma(17*N+1:18*N,:);
...
xxjoint=sqrt(xxdx.^2+xxdy.^2+...
    xxdx_ychannel.^2+xxdy_ychannel.^2);

yyjoint=sqrt(yydx.^2+yydy.^2+...
    yydx_ychannel.^2+yydy_ychannel.^2);


zzjoint=sqrt(zzdx.^2+zzdy.^2+...
    zzdx_ychannel.^2+zzdy_ychannel.^2);
...
projected_gammaxx_tx_ychannel=cxx_t1.*xxdx_ychannel+cxx_t2.*r.*(xxdx_ychannel)./(eps+xxjoint);
projected_gammaxx_ty_ychannel=cxx_t1.*xxdy_ychannel+cxx_t2.*r.*xxdy_ychannel./(eps+xxjoint);
...
projected_gammayy_tx_ychannel=cyy_t1.*yydx_ychannel+cyy_t2.*r.*(yydx_ychannel)./(eps+yyjoint);
projected_gammayy_ty_ychannel=cyy_t1.*yydy_ychannel+cyy_t2.*r.*yydy_ychannel./(eps+yyjoint);
...
projected_gammazz_tx_ychannel=czz_t1.*zzdx_ychannel+czz_t2.*r.*(zzdx_ychannel)./(eps+zzjoint);
projected_gammazz_ty_ychannel=czz_t1.*zzdy_ychannel+czz_t2.*r.*zzdy_ychannel./(eps+zzjoint);
...
projected_gammaxx_tx_ychannel(indx_xx)=0;
projected_gammaxx_ty_ychannel(indx_xx)=0;

projected_gammayy_t(indx_yy)=0;
projected_gammayy_tx(indx_yy)=0;
projected_gammayy_ty(indx_yy)=0;
projected_gammayy_tx_ychannel(indx_xx)=0;
projected_gammayy_ty_ychannel(indx_xx)=0;

projected_gammazz_t(indx_zz)=0;
projected_gammazz_tx(indx_zz)=0;
projected_gammazz_ty(indx_zz)=0;
projected_gammazz_tx_ychannel(indx_zz)=0;
projected_gammazz_ty_ychannel(indx_zz)=0;
...
projected_gamma(12*N+1:13*N,:)=projected_gammaxx_tx_ychannel;
projected_gamma(13*N+1:14*N,:)=projected_gammaxx_ty_ychannel;
projected_gamma(14*N+1:15*N,:)=projected_gammayy_tx_ychannel;
projected_gamma(15*N+1:16*N,:)=projected_gammayy_ty_ychannel;
projected_gamma(16*N+1:17*N,:)=projected_gammazz_tx_ychannel;
projected_gamma(17*N+1:18*N,:)=projected_gammazz_ty_ychannel;
