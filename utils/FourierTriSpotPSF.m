...
polar_par.phiD=zeros(1,1); polar_par.thetaD=pi/2*ones(1,1);

[XXy,XXx] = simDipole_novotny_v2_h(polar_par);

polar_par.phiD=pi/2*ones(1,1); polar_par.thetaD=pi/2*ones(1,1);

[YYy,YYx] = simDipole_novotny_v2_h(polar_par);

polar_par.phiD=pi/2*ones(1,1); polar_par.thetaD=0*ones(1,1);

[ZZy,ZZx] = simDipole_novotny_v2_h(polar_par);

polar_par.phiD=pi/4*ones(1,1); polar_par.thetaD=pi/2*ones(1,1);

[XYytmp,XYxtmp] = simDipole_novotny_v2_h(polar_par);

polar_par.phiD=0*ones(1,1); polar_par.thetaD=pi/4*ones(1,1);

[XZytmp,XZxtmp] = simDipole_novotny_v2_h(polar_par);

polar_par.phiD=pi/2*ones(1,1); polar_par.thetaD=pi/4*ones(1,1);
