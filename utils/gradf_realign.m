function g=gradf_realign(gamma,SMLM_img,b,FPSFx,FPSFy,recovStruct)
...
%------------------------------------------------------------
[c_x_temp,c_y_temp]=fast_mul_fft(reshapeMat(gamma));
% c_x_temp=c_temp(:,:,1);
% c_y_temp=c_temp(:,:,2);

c_x=bsxfun(@plus,reshape(down_sample(c_x_temp),M^2,n_f),b_x);
c_y=bsxfun(@plus,reshape(down_sample(c_y_temp),M^2,n_f),b_y);
...
%------------------------------------------------------------
    ...
    function out=reshapeMat(A)
        out=reshape(A,sqrt(N),sqrt(N),18,n_f);
    end
    ...
    function [out_N_xchannel,out_N_ychannel]=fast_mul_fft(x)
        
        
        xx_fft_br=fft2(xxgrid(x));
        yy_fft_br=fft2(yygrid(x));
        zz_fft_br=fft2(zzgrid(x));
        xy_fft_br=fft2(xygrid(x));
        xz_fft_br=fft2(xzgrid(x));
        yz_fft_br=fft2(yzgrid(x)); 
        
        out_N_xchannel=real(ifft2(...
        bsxfun(@times,FXXx,xx_fft_br)+ bsxfun(@times,FYYx,yy_fft_br)+ bsxfun(@times,FZZx,zz_fft_br)+...
            bsxfun(@times,FXYx,fft2(xy_fft_br))+bsxfun(@times,FXZx,fft2(xz_fft_br))+...
            bsxfun(@times,FYZx,fft2(yz_fft_br))+bsxfun(@times,FXXxdx,fft2(xxdxgrid(x)))+...
            bsxfun(@times,FXXxdy,fft2(xxdygrid(x)))+bsxfun(@times,FYYxdx,fft2(yydxgrid(x)))+...
            bsxfun(@times,FYYxdy,fft2(yydygrid(x)))+bsxfun(@times,FZZxdx,fft2(zzdxgrid(x)))+...
            bsxfun(@times,FZZxdy,fft2(zzdygrid(x)))));
        
        
           out_N_ychannel=real(ifft2(...
        bsxfun(@times,FXXy,xx_fft_br)+ bsxfun(@times,FYYy,yy_fft_br)+ bsxfun(@times,FZZy,zz_fft_br)+...
            bsxfun(@times,FXYy,fft2(xy_fft_br))+bsxfun(@times,FXZy,fft2(xz_fft_br))+...
            bsxfun(@times,FYZy,fft2(yz_fft_br))+bsxfun(@times,FXXydx,fft2(xxdxgrid_ychannel(x)))+...
            bsxfun(@times,FXXydy,fft2(xxdygrid_ychannel(x)))+bsxfun(@times,FYYydx,fft2(yydxgrid_ychannel(x)))+...
            bsxfun(@times,FYYydy,fft2(yydygrid_ychannel(x)))+bsxfun(@times,FZZydx,fft2(zzdxgrid_ychannel(x)))+...
            bsxfun(@times,FZZydy,fft2(zzdygrid_ychannel(x)))));     
            
            
        
%         bsxfun(@times,FXX,fft2(xxgrid(x)))+bsxfun(@times,FYY,fft2(yygrid(x)))+...
...
%             bsxfun(@times,FXXdx,fft2(reshape(xxdxgrid(x),xxdxgrid_ychannel(x),+...
%             bsxfun(@times,FXXydx,fft2(xxdxgrid_ychannel(x)))+ bsxfun(@times,FXXydy,fft2(xxdygrid_ychannel(x)))+...            
%             bsxfun(@times,FYYxdx,fft2(yydxgrid(x)))+ bsxfun(@times,FYYxdy,fft2(yydygrid(x)))+...
%             bsxfun(@times,FYYydx,fft2(yydxgrid_ychannel(x)))+ bsxfun(@times,FYYydy,fft2(yydygrid_ychannel(x)))+... 
%             bsxfun(@times,FZZxdx,fft2(zzdxgrid(x)))+ bsxfun(@times,FZZxdy,fft2(zzdygrid(x)))+...
%             bsxfun(@times,FZZydx,fft2(zzdxgrid_ychannel(x)))+ bsxfun(@times,FZZydy,fft2(zzdygrid_ychannel(x)))));       
%             bsxfun(@times,FXXdy,fft2(xxdygrid(x)))+...
...
%         out_N3_inN2_t=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
    ...
    function out_N3_inN2_t=xxdxgrid_ychannel(x)
        out_N3_inN2_t=(reshape(x(:,:,13,:),sqrt(N),sqrt(N),n_f));
%         out_N3_inN2_t=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
              out_N3_inN2_t(boundxryIndx,:)=0;
              out_N3_inN2_t(:,boundxryIndx)=0;
    end
...
%         out_N3_inN2=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
    ...
    function out_N3_inN2_t=xxdygrid_ychannel(x)
        out_N3_inN2_t=(reshape(x(:,:,14,:),sqrt(N),sqrt(N),n_f));
%         out_N3_inN2_t=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
              out_N3_inN2_t(boundxryIndx,:)=0;
              out_N3_inN2_t(:,boundxryIndx)=0;
    end
...
%         out_N3_inN2_t=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
    ...
    function out_N3_inN2_t=yydxgrid_ychannel(x)
        out_N3_inN2_t=(reshape(x(:,:,15,:),sqrt(N),sqrt(N),n_f));
%         out_N3_inN2_t=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
              out_N3_inN2_t(boundxryIndx,:)=0;
              out_N3_inN2_t(:,boundxryIndx)=0;
    end
...
%         out_N3_inN2=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
    ...
    function out_N3_inN2_t=yydygrid_ychannel(x)
        out_N3_inN2_t=(reshape(x(:,:,16,:),sqrt(N),sqrt(N),n_f));
%         out_N3_inN2=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
              out_N3_inN2_t(boundxryIndx,:)=0;
              out_N3_inN2_t(:,boundxryIndx)=0;
    end
...
%         out_N3_inN2=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
    ...
    function out_N3_inN2_t=zzdxgrid_ychannel(x)
        out_N3_inN2_t=(reshape(x(:,:,17,:),sqrt(N),sqrt(N),n_f));
%         out_N3_inN2=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
              out_N3_inN2_t(boundxryIndx,:)=0;
              out_N3_inN2_t(:,boundxryIndx)=0;
    end
...
%         out_N3_inN2=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
    ...
    function out_N3_inN2_t=zzdygrid_ychannel(x)
        out_N3_inN2_t=(reshape(x(:,:,18,:),sqrt(N),sqrt(N),n_f));
%         out_N3_inN2=(padarray(out_N3_inN2_t(6:end-5,6:end-5,:),[5,5]));
              out_N3_inN2_t(boundxryIndx,:)=0;
              out_N3_inN2_t(:,boundxryIndx)=0;
    end
